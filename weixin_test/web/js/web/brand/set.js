    ...
    error:function(msg){
     ...
     success:function(file_key,type){
         if(!file_key){
          ...
          var html = '<img src="'+common_ops.buildPicUrl('brand',file_key)+'"><span class="fa fa-times-circle del del_image" data="'+file_key+'"><i></i></span></span>';
...
var brand_set_ops = {
    ...
    delete_img:function(){
        $(".wrap_brand_set .del_image").unbind().click(function(){//unbind解除绑定事件，避免重复点击
            $(this).parent().remove();
        });
    }
};
