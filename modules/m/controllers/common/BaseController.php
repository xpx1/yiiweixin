...
class BaseController extends BaseWebController {
    ...
    protected function checkLoginStatus(){
        ...
        if( $member_id && preg_match("/^\d+$/",$member_id) ){
            ...
            $this->current_user = $member_info;//为了方便controller里面方便获取用户信息
            \Yii::$app->view->params['current_user'] = $member_info;//将用户信息保存在params的常量中，方便统一布局里面获取用户,可以直接用$this->params获取
            return true;
        }
        return false;
    }
